        ...
        <section className="space-y-8">
          <div className="text-center space-y-3">
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-[#00A4E0] text-white rounded-full shadow-lg">
              ...
              <h2 className="text-2xl font-black">Nos Spécialités</h2>
            </div>
            <p className="text-[#A6A6A6] text-lg max-w-2xl mx-auto">
              En intégrant l'ESIITECH, les étudiants peuvent préparer une <span className="font-bold text-[#00A4E0]">Licence</span> ou un <span className="font-bold text-[#00A4E0]">Master Professionnel</span> en informatique dans diverses spécialités
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {specialites.map((spec, index) => (
              <div
                key={index}
                className="group relative overflow-hidden bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-gray-200 hover:border-[#00A4E0] p-8"
              >
                <div className="absolute inset-0 bg-[#cfe3ff] opacity-0 group-hover:opacity-30 transition-opacity duration-300" />

                <div className="relative text-center space-y-4">
                  <div className="inline-flex w-20 h-20 bg-[#00A4E0] rounded-2xl items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="bg-gradient-to-br from-[#cfe3ff]/40 to-[#cfe3ff]/20 rounded-2xl p-8 border-2 border-[#cfe3ff]">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-[#00A4E0] rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg">
                <Users size={24} className="text-white" />
              </div>
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">
                  Étudiants boursiers et privés
                </h3>
                <p className="text-gray-700 leading-relaxed">
                  L'ESIITECH accueille chaque année aussi bien les <span className="font-bold text-[#00A4E0]">étudiants boursiers de l'État</span> que les <span className="font-bold text-[#00A4E0]">privés</span>, garantissant un accès équitable à une formation de qualité.
                </p>
              </div>
            </div>
          </div>
